 <?php $title = 'Administration Traction Animale'; ?>
	...
	<div class="col-lg-10 col-lg-offset-1">
			...
			<form method="post" action="backendRouter.php?action=addOnlyPhoto" enctype="multipart/form-data">
				<fieldset>
					<div class="form-group">
						...
						<input type="hidden" name="finalNamePhoto" value="traction">		
					</div>
		...
		<div class="panneau">
			...
			<form method="post" action="backendRouter.php?action=addText" enctype="multipart/form-data">
				<fieldset>
					<div class="form-group">
						<label for="choix_fichier">Choix de la photo du cheval (1 Mo max)</label>				
						<input type="hidden" name="sizeMax" value="1000000">				
						<input type="file" name="photo_a_envoyer">
						<input type="hidden" name="path" value="contents/images/traction_animale/">
					...
					<div class="form-group">
						<label for="textarea">Texte présentant les chevaux</label>
						<textarea type="textarea" rows="10" name="texteAccueil" class="form-control" placeholder="Mettez ici votre texte..."></textarea>
					</div>

					<input type="hidden" name="place"  value="administrationTraction" />
					<input type="hidden" name="table"  value="traction" />
				...
				<fieldset>
					...
					<select name="idPhoto">
						<optgroup label="Choisissez votre produit...">
							<?php
							foreach($resultsTractions as $row) {
							?>
		...
		<div class="panneau">
			...
			<form method="post" action="backendRouter.php?action=addText">
				<fieldset>
					...
					<input type="hidden" name="place"  value="administrationTraction" />
					<input type="hidden" name="table"  value="traction_intro_prestations" />
			...
			<form method="post" action="backendRouter.php?action=addText" enctype="multipart/form-data">
				<fieldset>
					<div class="form-group">
						...
						<input type="hidden" name="sizeMax" value="1000000">				
						<input type="file" name="photo_a_envoyer">
						<input type="hidden" name="path" value="contents/images/traction_animale/produits/">
					...
					<input type="hidden" name="place"  value="administrationTraction" />
					<input type="hidden" name="table"  value="traction_prestations" />
					<input type="hidden" name="idPhoto" value=<?= uniqid() ?> >
