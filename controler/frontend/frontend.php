...
{
	$textManager1 = new TextManager();
	$resultsElevagePorcs = $textManager1->getAllTextsWithPhotos('porcs');
...
{
	$textManager1 = new TextManager();
	$vergers = $textManager1->getAllTextsWithPhotos('verger');
...
{
	$textManager1 = new TextManager();
	$chevaux = $textManager1->getAllTextsWithPhotos('traction');
...
function roulottes() {
	$textManager1 = new TextManager();
	$roulottes = $textManager1->getAllTextsWithPhotos('roulotte');
